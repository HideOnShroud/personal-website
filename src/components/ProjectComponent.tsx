...
const ProjectComponent = ({ project }: Props) => {
    ...
    return (
        ...
        <div
            ...
            <img src={project.icon} alt="" className="rounded pointer-events-none"
            />
            ...
            <div className='inline-flex w-full pl-8 pr-8 justify-between'>
                ...
                {project.github ? (<button className='pl-5 pr-5 pt-2 pb-2 rounded-xl bg-[#001220]'><a href={project.github} target="_blank">GitHub</a></button>) : null}
                {project.link ? (<button className='pl-5 pr-5 pt-2 pb-2 rounded-xl bg-[#001220]'><a href={project.link} target="_blank">Demo</a></button>) : null}
